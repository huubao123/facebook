                      ...
                      elementss.childNodes[0].childNodes[1].childNodes[1].childNodes.forEach((elementsss, index) => {
                        if (elementsss.nodeName == 'DIV' && index == 1) {
                          ...
                          imgComment = elementsss.childNodes[0].childNodes[0].childNodes[0].childNodes[0].childNodes[0]
                            .childNodes[0]
                            ? elementsss.childNodes[0].childNodes[0].childNodes[0].childNodes[0].childNodes[0]
                        ...
                        if (elementsss.nodeName == 'UL') {
                          for (let m = 0; m < elementsss.childNodes.length; m++) {
                            ...
                            try {
                              ...
                              if (
                                children_div[0].parentNode.parentNode.parentNode.parentNode.parentNode.childNodes
                                  .length == 3
                              ) {
                                imgComment_cmt =
                                ...
                                if (
                                  ...
                                  count_like_cmtchild =
                                    children_div[0].parentNode.parentNode.parentNode.parentNode.parentNode.childNodes[1]
                                      ...
                                      ? 1
                                      : children_div[0].parentNode.parentNode.parentNode.parentNode.parentNode
                                          .childNodes[1].childNodes[0].childNodes[1].textContent;
                                }
                                ...
                                if (
                                  ...
                                  count_like_cmtchild =
                                    children_div[0].parentNode.parentNode.parentNode.parentNode.parentNode.childNodes[2]
                                      ...
                                      ? 1
                                      : children_div[0].parentNode.parentNode.parentNode.parentNode.parentNode
                                          .childNodes[2].childNodes[0].childNodes[1].textContent;
                                }
                              ...
                              if (children_div[0].parentNode.parentNode.childNodes[1]) {
                                ...
                                count_like_cmtchild =
                                  children_div[0].parentNode.parentNode.parentNode.parentNode.parentNode.childNodes[1]
                                    ...
                                    ? 1
                                    : children_div[0].parentNode.parentNode.parentNode.parentNode.parentNode
                                        .childNodes[1].childNodes[0].childNodes[0].childNodes[1].textContent;
                              }
