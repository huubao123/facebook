...
module.exports = async function main(req, res, next) {
  try {
    ...
    onFinished(page, async function () {
      await takedata(page, (length = lengths), (cmt_lengths = cmt_length)).then(async function (
        result
      ) {
...
async function takedata(page, length, cmt_lengths) {
  const dimension = await page.evaluate(
    async (length, cmt_lengths) => {
      ...
      for (let i = 1; i < length + 1; i++) {
        try {
          ...
          console.log(
            'content',
            contens.childNodes[0].childNodes[1].childNodes[0].childNodes[1].childNodes[0].childNodes
          );
            ...
            (element) => {
              if (element.nodeName == 'SPAN') {
                ...
                user_id = element.childNodes[0].childNodes[0].href
                  ...
                  : element.childNodes[0].childNodes[0].childNodes[0].href.split('/')[6];
              }
            }
          );
          contens.childNodes[0].childNodes[2].childNodes.forEach((element, index) => {
            if (element.className == '') {
              ...
              if (
                element.childNodes[0].childNodes[0].childNodes[0].childNodes[0].childNodes.length ==
                2
              ) {
                checkitemlength =
                  element.childNodes[0].childNodes[0].childNodes[0].childNodes[0].childNodes[0]
                    ...
                    element.childNodes[0].childNodes[0].childNodes[0].childNodes[0].childNodes[0].childNodes[
                      ...
                      : image_href.push(
                          element.childNodes[0].childNodes[0].childNodes[0].childNodes[0]
                            .childNodes[0].childNodes[j].childNodes[0].href
                        );
                  }
                } else {
                        ...
                        if (element.childNodes.length == 3) {
                          ...
                          element.childNodes.forEach(function (element) {
                            if (element.childNodes.length == 2) {
                              ...
                              image_href.push(element.childNodes[0].childNodes[0].href);
                            }
                          });
                        }
                      }
          ...
          if (
            ...
            likecomshare = divlikecomshare.childNodes[4].childNodes[0].childNodes[0].childNodes[0]
              .childNodes[0]
              ? divlikecomshare.childNodes[4].childNodes[0].childNodes[0].childNodes[0]
                  .childNodes[0]
              : undefined;
            divcommment =
              divlikecomshare.childNodes[4].childNodes[0].childNodes[0].childNodes[1].childNodes;
          } else {
            likecomshare = divlikecomshare.childNodes[3].childNodes[0].childNodes[0].childNodes[0]
              .childNodes[0]
              ? divlikecomshare.childNodes[3].childNodes[0].childNodes[0].childNodes[0]
                  .childNodes[0]
              : undefined;
            divcommment =
              ...
              element.childNodes.forEach((elementss) => {
                try {
                  if (elementss.childNodes[0].childNodes.length == 2) {
                    if (
                      elementss.childNodes[0].childNodes[1].childNodes[0].childNodes[0]
                        .childNodes[0].children[0].childNodes[0].childNodes[0].childNodes &&
                      elementss.childNodes[0].childNodes[1].childNodes[0].childNodes[0]
                        .childNodes[0].children[0].childNodes[0].childNodes[0].childNodes
                        .nodeName == 'SPAN'
                    ) {
                    ...
                    if (
                      ...
                      elementss.childNodes[0].childNodes[1].childNodes[0].childNodes[0]
                        .childNodes[0].children[0].childNodes[0].childNodes[0].childNodes[0]
                        .nodeName !== 'SPAN'
                    ) {
                      elementss.childNodes[0].childNodes[1].childNodes[1].childNodes.forEach(
                        (elementsss, index) => {
                            ...
                            try {
                              ...
                              if (
                                children_div[0].parentNode.parentNode.parentNode.parentNode
                                  .parentNode.childNodes.length == 3
                              ) {
                                imgComment_cmt =
                                  children_div[0].parentNode.parentNode.parentNode.parentNode
                                ...
                                children_div[0].parentNode.parentNode.parentNode.parentNode
                                  .parentNode.childNodes.length == 4
                              ) {
                                imgComment_cmt =
                                  children_div[0].parentNode.parentNode.parentNode.parentNode
                                        ...
                                        if (element.nodeName == 'DIV' && index == 2) {
                                          if (children22[2].childNodes[0].childNodes.length > 1) {
                                            count_like_cmtchild =
                                              ...
                                              ''
                                                ? 1
                                                : children22[1].childNodes[0].childNodes[1]
                                                    .innerText;
                                          }
                                          ...
                                          imgComment_cmt =
                                            children22[2].childNodes[0].childNodes[1].childNodes[0]
                                              ...
                                              ? children22[2].childNodes[0].childNodes[1]
                    ...
                    if (
                      ...
                      if (
                        elementss.childNodes[0].childNodes[0].childNodes[1].childNodes.length > 2
                      ) {
                        if (
